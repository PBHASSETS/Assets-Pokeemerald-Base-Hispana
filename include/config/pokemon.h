...
#define P_CUSTOM_GENDER_DIFF_ICONS       FALSE        // Si es TRUE, dará a más Pokémon íconos personalizados para sus formas femeninas, es decir, Hippopotas y Hippowdon
...
#define P_TWO_FRAME_FRONT_SPRITES        FALSE        // En Pokémon Esmeralda, los sprites frontales de Pokémon siempre consisten en dos cuadros. Esta configuración puede revertirlo para usar solo el primer cuadro, como en los otros juegos de Gen 3.
